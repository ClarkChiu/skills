# rules-en.md — 英文 AI 寫作痕跡（原樣收錄）

> 原樣收錄自 blader/humanizer 的 SKILL.md（v2.7.0、MIT）。
> 來源：https://github.com/blader/humanizer
> **規則內容保持原樣，不要修改**：這樣才能讓 skill-evolve 比對上游更新。
> 這個技能自己的設定和流程寫在 ../SKILL.md。英文文章用這份，中文文章改用 rules-zh-tw.md。
